export default function MainSlider() {
    return (
        <section className="main-slider">
                <div className="swiper-container main-swiper__container">
                    <div className="swiper-wrapper main-swiper-wrapper">
                        <div className="swiper-slide main__swiper-slide">
                            <div className="swiper-slide__content">
                                <div className="swiper-slide-title">
                                    <h2>Fast and Pro Game
                                        <span>Boosting services!</span>
                                    </h2>
                                </div>
                                <div className="swiper-slide__text">
                                    <p>More than <span>8 years</span> of experience and team of <span>1000+
                                            professional
                                            players</span></p>
                                </div>
                    ...
                    <div className="swiper-pagination main__swiper-pagination"></div>
                    <div className="swiper-button-prev main__swiper-button-prev"></div>
                    <div className="swiper-button-next main__swiper-button-next"></div>
                </div>
            </section>
    );
}