                ...
                <div className="review__slider-box">
                    ...
                    <div className="review__slider-add">
                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect x="8.89996" y="-0.00109863" width="15" height="1.8" rx="0.9"
                                  transform="rotate(90 8.89996 -0.00109863)" fill="white"/>
                        </svg>
                    ...
                    <div className="swiper-wrapper review__swiper-wrapper">
                        {
                            props.reviews.map(review => {
                                return(
                                    <Review name={review.NAME} previewText={review.PREVIEW_TEXT} key={review.ID} />
                                );
                            })
                        }
