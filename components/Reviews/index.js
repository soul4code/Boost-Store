export default function Reviews() {
    return (
        ...
        <div className="review__slider-container">
            <div className="review__slider-box">
                <div className="review__slider-title">
                    <h2>Reviews</h2>
                </div>
                <div className="review__slider-add">
                    <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0.5" y="6.59891" width="15" height="1.8" rx="0.9" fill="white"/>
                        <rect x="8.89996" y="-0.00109863" width="15" height="1.8" rx="0.9" transform="rotate(90 8.89996 -0.00109863)" fill="white"/>
                    </svg>

                </div>
                <div className="review__slider-column">
                    <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect y="4.19995" width="15" height="1.8" rx="0.9" fill="white"/>
                        <rect y="9.09998" width="15" height="1.8" rx="0.9" fill="white"/>
                        <rect width="15" height="1.8" rx="0.9" fill="white"/>
                    </svg>
                </div>
            </div>
            <div className="swiper-container review__swiper-container">
                <div className="swiper-wrapper review__swiper-wrapper">
                    <div className="swiper-slide review__swiper-slide">
                        <div className="review__swiper-box">
                            ...
                            <div className="review__swiper-info">
                                ...
                                <div className="review__swiper-stars">
                                    ...
                                    <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z" fill="#001020"/>
                                    </svg>
                                    <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z" fill="#001020"/>
                                    </svg>
                ...
                <div className="swiper-button-next review__swiper-button-next">
                    <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
